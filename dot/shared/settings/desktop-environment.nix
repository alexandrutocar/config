...
in {
      ...
      }
      {
        map.normal =
            ...
            foldl' recursiveUpdate {} (
              builtins.map (
                ...
                in {
                  ...
                  "Super \"${builtins.toString i}\"" = "set-focused-tags ${builtins.toString tags}";
                  # Super+Shift+[1-9] to tag focused view with tag [0-8]
                  "Super+Shift \"${builtins.toString i}\"" = "set-view-tags ${builtins.toString tags}";
                  # Super+Control+[1-9] to toggle focus of tag [0-8]
                  "Super+Control \"${builtins.toString i}\"" = "toggle-focused-tags ${builtins.toString tags}";
                  # Super+Shift+Control+[1-9] to toggle tag [0-8] of focused view
                  "Super+Shift+Control \"${builtins.toString i}\"" = "toggle-view-tags ${builtins.toString tags}";
                }
              ) (seq 1 9)
            )
          )
          ...
          in {
            ...
            "Super 0" = "set-focused-tags ${builtins.toString tags}";

            # Super+Shift+0 to tag focused view with all tags
            "Super+Shift 0" = "set-view-tags ${builtins.toString tags}";
          })
          // {
  ...
  programs = {
    ...
    foot = {
      enable = true;
      settings = {
        main.font = "${system.foot.font.name}:size=${builtins.toString system.foot.font.size}";
      };
    };
  ...
  services = {
    ...
    mako = {
      enable = true;
      settings = {
        font = "${system.font.name} ${builtins.toString system.font.size}";
        background-color = "#000000";
        border-color = "#AAAAAA";
        progress-color = "#232323";
      };
    };
