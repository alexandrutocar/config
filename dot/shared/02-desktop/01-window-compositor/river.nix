...
# ────────────────────────────────────────────────────────────────────────
{
  ...
  wayland.windowManager.river = let
    ...
    inherit (pkgs.custom.scripts) microphone-privacy camera-privacy screen-locker brightness launcher screen audio;
    ...
    settings = foldl' recursiveUpdate {} [
          ...
          map (
            mode: {
              map.${mode} = {
                ...
                "None XF86AudioMute" = "spawn '${getExe audio} /'";
                "Super XF86AudioMute" = "spawn '${getExe audio} /'";
                ...
                "None XF86WebCam" = "spawn '${getExe camera-privacy}'";
                "Super XF86WebCam" = "spawn '${getExe camera-privacy}'";
                "None XF86AudioMicMute" = "spawn '${getExe microphone-privacy}'";
                "Super XF86AudioMicMute" = "spawn '${getExe microphone-privacy}'";
              };

              map."-repeat".${mode} = {
                # Control pulse audio volume with pamixer (https://github.com/cdemoulins/pamixer)
                "None XF86AudioRaiseVolume" = "spawn '${getExe audio} +'";
                "None XF86AudioLowerVolume" = "spawn '${getExe audio} -'";
                "Super XF86AudioRaiseVolume" = "spawn '${getExe audio} +'";
                "Super XF86AudioLowerVolume" = "spawn '${getExe audio} -'";
      ...
      )
      {
        map.normal = {
          ...
          "Shift+Super S" = "spawn '${getExe screen}'";
        };
      }
      {
        map.normal =
          {
            ...
            "Super S" = "spawn '${getExe screen-locker}'";
